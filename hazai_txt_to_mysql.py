...
def conv_txt_to_csv(path, cursor):
    hanzai_list = {}
    ...
    for i in range(0, len(date_list)):
        cursor.execute('INSERT INTO hanzai VALUES ({},{},{},{},{},{})'.format(year + date_list[i], hanzai_list['路上強盗'][i], hanzai_list['ひったくり'][i], hanzai_list['空き巣'][i], hanzai_list['車上ねらい'][i], hanzai_list['自転車盗'][i]))
